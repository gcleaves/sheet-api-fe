...
<template>
      ...
      <ul>
          ...
          <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                  or
                  &quot;Our&quot; in this Agreement) refers to Sheet API.</p>
          </li>
          <li>
          ...
          <li>
              <p><strong>Website</strong> refers to Sheet API, accessible from <a href="https://sheetapi.dev"
                      rel="external nofollow noopener" target="_blank">https://sheetapi.dev</a></p>
          </li>
          <li>
  ...
  <ul>
      <li>By email: gcleaves@gmail.com</li>
  </ul>
</v-container>
</template>